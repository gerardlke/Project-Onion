      ...
      {isOpen && (
        <Html distanceFactor={6} position={[0, 0.6, 0]} center>
          <div style={{
            ...
            border: '1px solid #4f46e5', boxShadow: '0 4px 20px rgba(0,0,0,0.5)',
            fontFamily: 'sans-serif', fontSize: '14px',
            pointerEvents: 'auto', minWidth: '220px', maxWidth: '300px',
          }}>
            <h4 style={{ margin: '0 0 4px', color: '#a5b4fc' }}>{data.label}</h4>
            ...
            <button
              ...
              style={{ background: '#4f46e5', color: 'white', border: 'none', padding: '4px 8px', borderRadius: '4px', cursor: 'pointer', fontSize: '11px' }}
            >
              Close
            </button>
          </div>
